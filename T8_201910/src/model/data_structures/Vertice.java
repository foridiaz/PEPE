...
//	}
	 ...
	 */
	public void agregarArco(A pPeso,K inicio,K pLlave)
	{
...
//			{
//				infoVertex[hashCalculado]=new Arco<K,A>(pPeso,inicio,pLlave);
//				cargaInfoVertex++;
//			}
//		}
//		else
//		{
//			reHash();
//			agregarArco( pPeso,inicio, pLlave);
//		}
		infoVertex.add(new Arco<K,A>(pPeso, inicio, pLlave)); 
	}
...
//			if(copiaHash[i]!=null)
//			{
//				agregarArco((A)copiaHash[i].darPeso(),(K)copiaHash[i].darInicio(),(K)copiaHash[i].darAdyacente());
//			}
//		} 
	}
