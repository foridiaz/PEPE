...
//		}
	...
	public void addEdge(K idVertexIni, K idVertexFin, A infoArc )
	{
		...
		{
			arreglo[hashCalculado1].agregarArco(infoArc,idVertexIni,idVertexFin); //se agrega el peso del arco y el vertice Fin como conexion al primero
			arreglo[hashCalculado2].agregarArco(infoArc,idVertexIni,idVertexIni); //se agrega el peso del arco y el vertice Ini como conexion al segundo
		}
